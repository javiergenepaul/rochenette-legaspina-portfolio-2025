...
export default function ApproachSection2026() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(150deg,#1a0000 0%,#2d0000 60%,#1a0510 100%)" }}
    >
      {/* Ambient orbs */}
      <div className="absolute top-[-80px] right-[-40px] w-[380px] h-[380px] rounded-full opacity-18 pointer-events-none"
        style={{ background: "#D32F2F", filter: "blur(100px)" }} />
      <div className="absolute bottom-[-60px] left-[5%] w-[260px] h-[260px] rounded-full opacity-18 pointer-events-none"
      ...
      <div className="relative z-10">
        ...
        <p className="text-white/50 text-[0.95rem] leading-[1.75] max-w-[560px] mb-12">
          A structured, iterative process that keeps stakeholders aligned and solutions grounded in reality.
        </p>
          ...
          {APPROACH_STEPS.map(({ number, title, description }, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-[38px] h-[38px] rounded-[10px] bg-amethyst-500/20 border border-amethyst-500/35 flex items-center justify-center mb-3">
                  <Icon size={18} className="text-amethyst-300" strokeWidth={1.75} />
                </div>
