  ...
  return (
    ...
    >
      ...
      <p className="text-woodsmoke-500 dark:text-woodsmoke-400 text-[0.95rem] leading-[1.75] max-w-[560px] mb-12">
        Formal education combined with self-directed learning across multiple disciplines.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {EDUCATION.map(({ degree, institution, year, description }) => (
          ...
          >
            <div className="min-w-[42px] h-[42px] bg-amethyst-50 dark:bg-amethyst-500/15 rounded-[11px] flex items-center justify-center shrink-0">
              <GraduationCap size={20} className="text-amethyst-500" strokeWidth={1.75} />
            </div>
            <div>
              ...
              <div className="flex items-center gap-1 text-woodsmoke-400 text-[0.72rem] mb-1.5">
                <Calendar size={12} className="text-amethyst-300" strokeWidth={1.75} />
                {year}
              </div>
