  ...
  return (
    ...
    >
      ...
      <p className="text-woodsmoke-500 dark:text-woodsmoke-400 text-[0.95rem] leading-[1.75] max-w-[560px] mb-12">
        Tools and technologies I&apos;ve used across 3D modeling, design, and systems analysis.
      </p>
        ...
        {SKILLS.map(({ category, items }) => (
          <div key={category}>
            ...
            <div className="flex items-center gap-2.5 font-poppins font-bold text-[0.85rem] text-woodsmoke-900 dark:text-woodsmoke-100 mb-5">
              <Wrench size={16} className="text-amethyst-500" strokeWidth={1.75} />
              {category}
              ...
              {items.map(({ name, icon }) => (
                <div
                  ...
                  className={cn(
                    ...
                    "rounded-[16px] px-3.5 py-4 min-w-[88px] cursor-default",
